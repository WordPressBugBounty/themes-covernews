...
= 7.5.0 - Sep 17, 2026 =
* Added support for displaying author images in featured news and header post blocks.
* Added Author Icon Options support for featured banner news blocks.
* Added and improved local font support.
* Improved mobile trending news display.
* Improved featured banner tabs and category handling.
* Improved theme menus and admin bar functionality.
* Improved starter site links and useful plugin recommendations.
* Improved translation and language file support.
* Fixed issues with header menu settings.
* Fixed banner tabs and category display issues.
* Optimized theme styles and CSS.
* Updated theme documentation and readme.
...
* Update - Archives image improvement
* Update - Page Builders compatibility improvement
* Update - Block Style improvement
* Fixed - Some styling glitch
...
* Update - Accessibilty improvement
* Update - WooCommerce compatibility improvement
* Update - Page builder compatibility improvement
* Update - Speed optimization
...
= 4.8.2 - Oct 02 2024 =
* Update - Breadcrumb improvements
* Update - Block Style improvement
* Fixed - Some styling glitch

= 4.8.1 - Oct 01 2024 =
* Update - Header image speed optimization
* Option - Google Fonts speed optimization
* Update - Block Style improvement
* Fixed - Some styling glitch

= 4.8.0 - Sep 17 2024 =
* Update - Single Posts Tags display disabled by default
* Option - Customize > Theme Options > Single Posts Settings
...
= 4.7.1 - Aug 14 2024 =
* Update - WordPress Global Style improvement
* Update - Block Style improvement
* Fixed - Some styling glitch
