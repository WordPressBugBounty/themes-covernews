    ...
    function covernews_dashboard_notice_content(){
		...
		$notice_starter_msg =sprintf(
			'<div class="aft-notice-col-2">
				...
				__( 'Click, Import, Wow! No Coding - Your Site Ready in Minutes!', 'covernews' ),
				esc_html__( 'Explore our ready-to-use websites! No coding required—just one click to import a demo and have your site up in minutes. Thanks for choosing our theme—let your creativity shine!', 'covernews' ),
				$af_companion_url,
			$af_companion_title,
			esc_url($demo_link),
		...
		$notice_external_msg =sprintf(
			...
			<div class="aft-documentation-links">
				...
				<div>
					<a href="https://afthemes.com/products/covernews-pro/" target="_blank" class="button">%6$s</a>
				</div>
			</div>
			</div>',
			...
			esc_html__( 'Unlock Premium Features', 'covernews' )
